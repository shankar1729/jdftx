...
#ifndef FLUID1D_FLUID1D_IDEALGAS_H
#define FLUID1D_FLUID1D_IDEALGAS_H
...
public:
	...
	ScalarFieldCollection V; //!< external site potentials
	...
	virtual void getDensities(const ScalarField* indep, ScalarField* N, double& P) const=0;
	...
	virtual double compute(const ScalarField* indep, const ScalarField* N, ScalarField* grad_N,
		const double& P, double& grad_P, const double Nscale, double& grad_Nscale) const=0;
	...
	virtual void convertGradients(const ScalarField* indep, const ScalarField* N,
		const ScalarField* grad_N, double grad_P, ScalarField* grad_indep, const double Nscale) const=0;
...
#endif // FLUID1D_FLUID1D_IDEALGAS_H
