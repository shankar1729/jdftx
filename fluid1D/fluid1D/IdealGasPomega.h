...
#ifndef FLUID1D_FLUID1D_IDEALGASPOMEGA_H
#define FLUID1D_FLUID1D_IDEALGASPOMEGA_H
...
public:
	...
	void initState(const ScalarField* Vex, ScalarField* logPomega, double scale, double Elo, double Ehi) const;
	void getDensities(const ScalarField* logPomega, ScalarField* N, double& P) const;
	double compute(const ScalarField* logPomega, const ScalarField* N, ScalarField* grad_N,
		const double& P, double& grad_P, const double Nscale, double& grad_Nscale) const;
	void convertGradients(const ScalarField* logPomega, const ScalarField* N,
...
#endif // FLUID1D_FLUID1D_IDEALGASPOMEGA_H
