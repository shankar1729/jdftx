...
void eblas_scatter_zdaxpy(const int Nindex, double a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Scatter y(index) += a * (x or conj(x)) (in Octave notation)
void eblas_scatter_zaxpy(const int Nindex, complex a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Scatter y(index) += a * (x or conj(x)) (in Octave notation)
...
void eblas_gather_zdaxpy(const int Nindex, double a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Gather y += a * (x(index) or conj(x(index)) (in Octave notation)
void eblas_gather_zaxpy(const int Nindex, complex a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Gather y += a * (x(index) or conj(x(index)) (in Octave notation)
...
#ifdef GPU_ENABLED
void eblas_scatter_zdaxpy_gpu(const int Nindex, double a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Scatter y(index) += a * (x or conj(x)) (in Octave notation)
void eblas_scatter_zaxpy_gpu(const int Nindex, complex a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Scatter y(index) += a * (x or conj(x)) (in Octave notation)
...
void eblas_gather_zdaxpy_gpu(const int Nindex, double a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Gather y += a * (x(index) or conj(x(index)) (in Octave notation)
void eblas_gather_zaxpy_gpu(const int Nindex, complex a, const int* index, const complex* x, complex* y, bool conjugate=false); //!< Gather y += a * (x(index) or conj(x(index)) (in Octave notation)
