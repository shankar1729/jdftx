...
@param center The origin for spherical coordinates [default = center of box (if null pointer is passed)]
*/
void saveSphericalized(const DataRptr* dataR, int nColumns, const char* filename, double drFac=1.0, vector3<>* center=0);
...
@param nColumns Number of DataGptr's in dataG[]
...
*/
void saveSphericalized(const DataGptr* dataG, int nColumns, const char* filename, double dGFac=1.0);
