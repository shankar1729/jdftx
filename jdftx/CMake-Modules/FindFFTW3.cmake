...
if(FFTW3_MPI_REQUIRED)
	find_path(FFTW3_MPI_INCLUDE_DIR fftw3-mpi.h ${FFTW3_PATH} ${FFTW3_PATH}/include NO_DEFAULT_PATH)
	find_path(FFTW3_MPI_INCLUDE_DIR fftw3-mpi.h)
	if(FFTW3_FIND_REQUIRED AND (NOT FFTW3_MPI_INCLUDE_DIR))
		set(FFTW3_FOUND FALSE)
		message(FATAL_ERROR "Could not find FFTW3 MPI headers (Add -D FFTW3_PATH=<path> to the cmake commandline for a non-standard installation)")
	endif()
	find_library(FFTW3_MPI_LIBRARY NAMES fftw3_mpi PATHS ${FFTW3_PATH} ${FFTW3_PATH}/lib ${FFTW3_PATH}/lib64 NO_DEFAULT_PATH)
	find_library(FFTW3_MPI_LIBRARY NAMES fftw3_mpi)
	if(FFTW3_FIND_REQUIRED AND (NOT FFTW3_MPI_LIBRARY))
		set(FFTW3_FOUND FALSE)
		message(FATAL_ERROR "Could not find FFTW3 MPI library (Add -D FFTW3_PATH=<path> to the cmake commandline for a non-standard installation)")
	endif()
endif()

if(FFTW3_FOUND)
	if(NOT FFTW3_FIND_QUIETLY)
		message(STATUS "Found FFTW3: ${FFTW3_MPI_LIBRARY} ${FFTW3_THREADS_LIBRARY} ${FFTW3_LIBRARY}")
	endif()
else()
