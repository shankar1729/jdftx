...
if(EnableScaLAPACK AND (NOT ForceScaLAPACK))
	...
	if(NOT MKL_BLACS_MPI)
		#Set default based on compiler:
		if((${CMAKE_CXX_COMPILER_ID} MATCHES "GNU") OR (${CMAKE_CXX_COMPILER_ID} MATCHES "Clang"))
			set(MKL_BLACS_MPI "openmpi")
		elseif(${CMAKE_CXX_COMPILER_ID} MATCHES "Intel")
			set(MKL_BLACS_MPI "intelmpi")
		else()
			message(FATAL_ERROR "Specify MKL_BLACS_MPI explicitly; no default for ${CMAKE_CXX_COMPILER_ID}.")
		endif()
		message(STATUS "MKL_BLACS_MPI not specified: defaulting to '${MKL_BLACS_MPI}' for ${CMAKE_CXX_COMPILER_ID} compiler")
	endif()
	find_library(MKL_BLACS_LIBRARY NAMES "mkl_blacs_${MKL_BLACS_MPI}_lp64" PATHS ${MKL_LIB_PATH})
