...
#ifndef JDFTX_ELECTRONIC_VANDERWAALSBJD3_H
#define JDFTX_ELECTRONIC_VANDERWAALSBJD3_H
...
private:
	...
	double a1, a2; //factors in damping of r^-6 and r^-8 terms corresponding to e.exCorr
...
//! @}
#endif // JDFTX_ELECTRONIC_VANDERWAALSBJD3_H
