...
//! @{
//! @file common.h Forward-declarations for commonly used classes in the electronic part

class matrix;         //!< general purpose matrix
class diagMatrix;     //!< real diagonal matrix
class ColumnBundle;   //!< stores wavefunctions
class QuantumNumber;  //!< a set of quantum numbers: k and spin
...
struct ElecGradient;   //!< Vector space entry for electronic minimization
struct IonicGradient;  //!< Vector space entry for ionic minimization
class VanDerWaals;     //!< pair-potential van der waals corrections
class Vibrations;      //!< vibrational modes and free energy calculator
